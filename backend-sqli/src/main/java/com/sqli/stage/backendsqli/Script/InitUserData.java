...
public class InitUserData implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (userRepository.count() == 0) {
            ...
            createUser("Abdelouahed DEBBAGH", "abdou.d@rfcdigital.com", "Abdelouahed!2025", "Chargé de projets TMA", Role.CHEF_DE_PROJET, TypeDepartment.MANAGEMENT, "+212 666-060312");
            createUser("Ayoub El Manssouri", "ayoub.elmansouri@gmail.com", "Ayoub!2025", null, Role.DEVELOPPEUR, null, null);
            createUser("Mustapha KHALKI", "mustapha@rfcdigital.dev", "Mustapha!2025", "Dev Fullstack", Role.DEVELOPPEUR, TypeDepartment.DEVELOPPEMENT, null);
            createUser("Chafia HASSOUD", "chafia.hassoud01@gmail.com", "Chafia!2025", "Contrôleuse qualité et webmaster", Role.DEVELOPPEUR, TypeDepartment.EXTERNE, null);
            ...
            createUser("Imad Ghssisse EXT", "mohibimaddev@gmail.com", "Imad!2025", "Dev Fullstack", Role.DEVELOPPEUR, TypeDepartment.DEVELOPPEMENT, null);
            createUser("Imane ACHKOUNE", "imane.a@rfcdigital.com", "Imane!2025", "Chef de projet", Role.CHEF_DE_PROJET, TypeDepartment.MANAGEMENT, "+212 662-387174");
            createUser("Imane ACHOUALE", "imane.achoual@rfcdigital.dev", "Imane!2025", "Dev Fullstack", Role.DEVELOPPEUR, TypeDepartment.DEVELOPPEMENT, "+212 662-439992");
            createUser("Amine AKERMOUD", "amine.akermoud@rfcdigital.dev", "Amine!2025", "Dev Fullstack", Role.DEVELOPPEUR, TypeDepartment.DEVELOPPEMENT, "+212 640-610184");
            createUser("Abdarazak Laanaya EXT", "laanayabdrazak@gmail.com", "Abdarazak!2025", null, Role.DEVELOPPEUR, null, null);
            ...
            createUser("Ayoub SABI", "ayoub.sabi.dev@gmail.com", "Ayoub!2025", null, Role.DEVELOPPEUR, null, null);
            createUser("Hicham SOUFIANI", "hicham.s@rfcdigital.com", "Hicham!2025", "Chef de projet", Role.CHEF_DE_PROJET, TypeDepartment.MANAGEMENT, "+212 766-510077");
            createUser("Mohamed Aherdane EXT", "mohamed.aherdane@waveagency.fr", "Mohamed!2025", null, Role.DEVELOPPEUR, null, null);
            createUser("Mohamed TBARKA", "simo.tbarka@gmail.com", "Mohamed!2025", "LEAD TEK", Role.DEVELOPPEUR, TypeDepartment.DEVELOPPEMENT, null);
            createUser("Abdeslam BOUGAA", "Abdo.bougaa@gmail.com", "Abdeslam!2025", null, Role.DEVELOPPEUR, null, null);
            createUser("Aya OUAHI", "ayaouahi99@gmail.com", "Aya!2025", "stagiaire", Role.STAGIAIRE, TypeDepartment.DEVELOPPEMENT, null);
            createUser("Mohamed AZZAM", "azzam.moo@gmail.com", "azzam!2025", "stagiaire", Role.STAGIAIRE, TypeDepartment.DEVELOPPEMENT, null);
            createUser("Mohamed MAKKAOUI", "makkaoui@rfcdigital.dev", "Mohamed!2025", "Dev Fullstack", Role.DEVELOPPEUR, null, null);
            createUser("Anass AIT BELARBI", "anassaitbelarbi7@gmail.com", "Anass!2025", null, Role.DEVELOPPEUR, null, null);
            createUser("Yasser El Mimouni", "elmimouni.yasser@gmail.com", "Yasser!2025", null, Role.DEVELOPPEUR, null, null);
        }
    }
