...
public class InitUserData implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (userRepository.count() == 0) {
            ...
            createUser("Mustapha KHALKI", "mustapha@rfcdigital.dev", "Mustapha!2025", "Dev Fullstack", Role.ADMIN, TypeDepartment.DEV, null);
            ...
            createUser("Achraf ALAMI", "achraf.a@rfcdigital.dev", "Achraf!2025", "Dev Fullstack", Role.ADMIN, TypeDepartment.DEV, "+212 762-628323");
            createUser("Salma ELGMIRI", "salma.e@rfcdigital.dev", "Salma!2025", "Dev Fullstack", Role.ADMIN, TypeDepartment.DEV, null);
            ...
            createUser("Abdoulkader", "abdoukadriadamou75@gmail.com", "Abdoulkader!2025", "Dev Fullstack", Role.ADMIN, TypeDepartment.DEV, null);
            ...
            createUser("Imad Ghssisse EXT", "mohibimaddev@gmail.com", "Imad!2025", "Dev Fullstack", Role.ADMIN, TypeDepartment.DEV, null);
            ...
            createUser("Imane ACHOUALE", "imane.achoual@rfcdigital.dev", "Imane!2025", "Dev Fullstack", Role.ADMIN, TypeDepartment.DEV, "+212 662-439992");
            createUser("Amine AKERMOUD", "amine.akermoud@rfcdigital.dev", "Amine!2025", "Dev Fullstack", Role.ADMIN, TypeDepartment.DEV, "+212 640-610184");
            ...
            createUser("Mohamed TBARKA", "simo.tbarka@gmail.com", "Mohamed!2025", "LEAD TEK", Role.ADMIN, TypeDepartment.DEV, null);
            createUser("Abdeslam BOUGAA", "Abdo.bougaa@gmail.com", "Abdeslam!2025", null, Role.ADMIN, null, null);
            createUser("Aya OUAHI", "ayaouahi99@gmail.com", "Aya!2025", "stagiaire", Role.ADMIN, TypeDepartment.DEV, null);
